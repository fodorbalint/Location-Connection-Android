...
namespace LocationConnection
{
	...
	{
		public new ViewGroup MainLayout;
        AndroidX.AppCompat.Widget.Toolbar PageToolbar;
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			try
			{
				...
				PageToolbar = FindViewById<AndroidX.AppCompat.Widget.Toolbar>(Resource.Id.PageToolbar);
		...
		{
            c.SnackStr("Function not available.");
