    ...
    public class ListActivity : BaseActivity, IOnMapReadyCallback
	{
		...
		protected override async void OnResume()
		{
			try {
				...
				view.LoadUrl("https://locationconnection.me");
				view.EvaluateJavascript("document.body.innerHTML", new JavaScriptResult());

				stw.Stop();
				string cookies = CookieManager.Instance.GetCookie("locationconnection.me");
				c.Log("Page loading in " + stw.ElapsedMilliseconds + ", Cookie: " + cookies);
				view.Destroy();*/
